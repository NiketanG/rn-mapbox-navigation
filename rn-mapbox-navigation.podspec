...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  Smart Mapbox turn-by-turn routing based on real-time traffic for React Native.
                   DESC
  s.homepage     = "https://github.com/stoovo/rn-mapbox-navigation.git"
  s.license    = { :type => "MIT", :file => "LICENSE" }
  s.authors      = { "Holler Taxi" => "support@stoovo.com.com" }
  s.platforms    = { :ios => "11.0" }
  s.source       = { :git => "https://github.com/stoovo/rn-mapbox-navigation.git", :tag => "#{s.version}" }
